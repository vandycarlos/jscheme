...
/**
 * A closure is a user-defined procedure. It is "closed" over the environment in which it was
 * created. To apply the procedure, bind the parameters to the passed in variables, and evaluate the
 * body.
 *
