...
/**
 * Environments allow you to look up the value of a variable, given its name. Keep a list of
 * variables and values, and a pointer to the parent environment. If a variable list ends in a
 * symbol rather than null, it means that symbol is bound to the remainder of the values list.
 *
...
public class Environment extends SchemeUtils {
  ...
  public Object set(Object var, Object val) {
    if (!(var instanceof String)) return error("Attempt to set a non-symbol: " + stringify(var));
    ;
