...
/**
 * A Pair has two fields, first and rest (or car and cdr). The empty list is represented by null.
 * The methods that you might expect here, like first, second, list, etc. are instead static methods
    ...
    if ((rest instanceof Pair) && rest(rest) == null)
      special =
          (first == "quote")
              ...
              : (first == "quasiquote")
                  ? "`"
                  : (first == "unquote") ? "," : (first == "unquote-splicing") ? ",@" : null;
